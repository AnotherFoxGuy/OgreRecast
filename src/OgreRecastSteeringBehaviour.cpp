...
{ 
  ...
  // COMMENTED OUT AS ITS USING WIN32 GDI ATM, NEED TO CONVERT TO OGRE
  // ALSO FIND A MORE EFFIFIENT WAY OF DRWAING WITHOUT MANUAL OBJECTS AND
  // WITHOUT ACCESSING THE DEVICE MANUALLY
 /*
   gdi->TransparentText();
