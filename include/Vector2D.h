...
//  Name:   Vector2D.h
//
//  Desc:   2D vector struct modified to use Ogre::Vector3 Objects
//
...
#ifndef __H_OGRERECASTVECTOR2D_H__
#define __H_OGRERECASTVECTOR2D_H__
...
struct Vector2D
{
	...
	Vector2D():x(0.0),y(0.0),yUP(0.0){}
	Vector2D(double a, double b):x(a),y(b),yUP(0.0){}
	Vector2D(double xVal, double yUPVal, double zVal):x(xVal),y(zVal),yUP(yUPVal){}

	//sets x and y to zero
	void Zero(){x=0.0; y=0.0; yUP=0.0;}
...
#endif // __H_OGRERECASTVECTOR2D_H__